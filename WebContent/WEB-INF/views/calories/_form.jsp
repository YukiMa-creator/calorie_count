...
<label>食品コード</label><br />
<c:out value="${sessionScope.food.code}" />
<br /><br />

<label>食べ物</label><br />
<c:out value="${sessionScope.food.name}" />
<br /><br />

<label>量</label><br />
<c:out value="${sessionScope.food.amount}" />
<br /><br />

<label>カロリー</label><br />
<c:out value="${sessionScope.food.kcal}" />
<br /><br />
